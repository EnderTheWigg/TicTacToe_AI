...
implements AI
{
    ...
    public Point getNextMove(TicTacToe game, TicTacToePiece myPiece)
    {
        ...
        List<MinMaxNode> nodeList = new ArrayList<MinMaxNode>();
        for(MinMaxNode childNode: gameTree.getChildrenData()){
        ...
        {
            if(node.getScore() > highest)
                highest = node.getScore();
        }
